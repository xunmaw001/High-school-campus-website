...
public class XiaoyuangonggaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XiaoyuangonggaoEntity xiaoyuangonggao, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XiaoyuangonggaoEntity xiaoyuangonggao, HttpServletRequest request){
        EntityWrapper<XiaoyuangonggaoEntity> ew = new EntityWrapper<XiaoyuangonggaoEntity>();
    	PageUtils page = xiaoyuangonggaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xiaoyuangonggao), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
    ...
    public R info(@PathVariable("id") Long id){
		...
		xiaoyuangonggao.setClicknum(xiaoyuangonggao.getClicknum()+1);
		xiaoyuangonggaoService.updateById(xiaoyuangonggao);
    ...
    public R save(@RequestBody XiaoyuangonggaoEntity xiaoyuangonggao, HttpServletRequest request){
    	xiaoyuangonggao.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<XiaoyuangonggaoEntity> wrapper = new EntityWrapper<XiaoyuangonggaoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = xiaoyuangonggaoService.selectCount(wrapper);
