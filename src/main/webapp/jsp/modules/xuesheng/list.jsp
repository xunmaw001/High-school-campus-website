...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="nianjiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										班级
									</label>
	...
	<script>
		...
		function search(){
			...
			if($('#nianjiSearch').val() != null && $('#nianjiSearch').val() != ''){
				searchForm.nianji ="%" +  $('#nianjiSearch').val() + "%";
			}
